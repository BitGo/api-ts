...
export const TestCasesFromString = new t.Type<NonEmptyArray<TestCase>, NonEmptyArray<TestCaseAst>, string>(
  'TestCaseFromAst',
  ...
  (testCases) => pipe(
    ...
    NEA.map((testCase) => ({
      ...
      expectedOutput: JSON.stringify(testCase.expectedOutput, null, 2) as NonEmptyString,
    }))
  )
)
